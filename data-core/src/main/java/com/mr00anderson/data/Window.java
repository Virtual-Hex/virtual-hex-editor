...
//     */
    ...
    public Window(String label, boolean open, int flags, Drawables drawables) {
        this.label = label;
        this.open = open;
        this.flags = flags;
    ...
    public Window(String label, boolean open, int flags, Drawables drawables, ActivationHandler<Window> onActivation) {
        this.label = label;
        this.open = open;
        this.flags = flags;
        this.drawables = drawables;
