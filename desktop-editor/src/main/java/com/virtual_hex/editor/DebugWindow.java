...
//
//import com.mr00anderson.jawe.worldsHeader.Drawable;
...
//
//    @Override
//    public void loop(JImGui imGui, World worldWrapper) {
...
//                imGui.separator();
//                imGui.data("By Omar Cornut and all dear imgui contributors.");
//                imGui.data("Dear ImGui is licensed under the MIT License, see LICENSE for more information.");
//                imGui.end();
//            }
//
...
//                    imGui.menuItem("Long data display", null, show_app_long_text);
...
//                    imGui.textWrapped(
//                            "The logging API redirects all data output so you can easily capture the content of a window or a block. Tree nodes can be automatically expanded. You can also call ImGui::LogText() to output directly to the log without a visual output.");
//                    imGui.logButtons();
//                    imGui.treePop();
//                }
//            }
...
//                        imGui.sameLine();
//                        imGui.data("Thanks for clicking me!");
//                    }
//
...
//                    imGui.sameLine();
//                    imGui.radioButton("radio W_IMGUI_ABOUT", e, 2);
//
//                    for (int i = 0; i < 7; i++) {
...
//                    if (imGui.isItemHovered()) {
//                        imGui.beginTooltip();
//                        imGui.data("I am a fancy tooltip");
...
//            imGui.data("Simple overlay\nin the corner of the screen.\n(right-click to change position)");
//            imGui.sameLine();
//            showHelpMarker(imGui, "This is another help.");
//            imGui.separator();
//            if (imGui.isMousePosValid())
//                imGui.data("Mouse Position: (" + imGui.getIO().getMousePosX() + ", " + imGui.getIO().getMousePosY() + ")");
//            else imGui.data("Mouse Position: <invalid>");
...
//        imGui.data("This window has a changing title.");
//        imGui.end();
//    }
//
//    @SuppressWarnings("AccessStaticViaInstance")
...
//            imGui.menuItem("fish_hat.W_IMGUI_ABOUT");
...
//        imGui.bulletText("CTRL+Click on a slider or drag box to input value as data.");
//        if (imGui.getIO().isFontAllowUserScaling()) imGui.bulletText("CTRL+Mouse Wheel to zoom window contents.");
//        imGui.bulletText("Mouse Wheel to scroll.");
//        imGui.bulletText("While editing data:\n");
//        imGui.indent();
//        imGui.bulletText("Hold SHIFT or use mouse to select data.");
