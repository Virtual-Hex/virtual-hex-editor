...
//
//public class UIPluginsManager<T> {
//
//    /**
//     * Simply a logger reference
//     */
//    private static final Logger L = LoggerFactory.getLogger(UIPluginsManager.class);
//
//    private final Path pluginDataPath;
//    private final String target;
//    private final Map<String, UIWriter<T>> plugins;
//
//    public UIPluginsManager(Path pluginDataPath, String target) {
//        this.pluginDataPath = pluginDataPath;
//        this.target = target;
//        this.plugins = new ConcurrentHashMap<>(16, 0.75f,1);
//    }
//
//    public List<UIWriter> loadPlugins(File directory) throws IOException {
//        return loadPlugins(directory.getAbsoluteFile().toPath());
//    }
//
//    public List<UIWriter> loadPlugins(Path directory) throws IOException {
...
//
//
//    public List<UIWriter> loadPlugins(File... files) {
//        int length = files.length;
//        List<UIWriter> plugins = new ArrayList<>(length);
//        for (int i = 0; i < length; i++) {
//            File file = files[i];
//            UIWriter pluginHolder = loadPlugin(file);
...
//
//
//    public List<UIWriter> loadPlugins(Path... files) {
//        int length = files.length;
//        List<UIWriter> plugins = new ArrayList<>(length);
//        for (int i = 0; i < length; i++) {
//            Path file = files[i];
//            UIWriter pluginHolder = loadPlugin(file.toFile());
//            plugins.add(pluginHolder);
//        }
//        return plugins;
//    }
//
//    @Override
//    public UIWriter loadPlugin(Path file){
//        return loadPlugin(file.toFile());
//    }
//
//    @Override
//    public UIWriter loadPlugin(File file){
...
//        try {
//            pluginClazzLoader = new ChildFirstClazzLoader(new URL[]{file.toURI().toURL()});
