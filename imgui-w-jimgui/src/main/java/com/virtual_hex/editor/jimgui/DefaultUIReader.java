 ...
 * @param <T>
 */
public class DefaultUIReader<T> implements UIReader<T> {
    ...
    public DefaultUIReader(boolean scanForHandlers, ScanResult... scanResults) {
        this(0, scanForHandlers, scanResults);
    }

    // TODO Scans being provided to provide more app level configuration
    public DefaultUIReader(int version, boolean scanForHandlers, ScanResult... sca) {
    ...
    // TODO REVAMP SEE Editor for better usage of scan results
