...
//     */
//    public static final Drawable SEPARATOR = new JaweSeparator();
//
//    /**
//     * next column, defaults to current row or next row if the current row is finished
//     */
//    public static final Drawable NEXT_COLUMN = new JaweNextColumn();
//
//    /**
//     * undo a SameLine() or force a new line when in an horizontal-layout context.
//     */
//    public static final Drawable NEW_LINE = new JaweNewLine();
//
//
//    public static final Drawable SAME_LINE = new JaweSameLine();
//
//    public static final Drawable TREE_POP = new JaweTreePop();
//
//    /**
