...
import com.mr00anderson.editor.jimgui.wrappers.WrappedTextBuffer;
...
public class DefaultJImGuiStringPrimTypeHandler implements JImGuiTypeHandler {
    ...
    // Cache
    protected Int2ObjectMap<Map<String, WrappedTextBuffer>> int2ObjectMap = new Int2ObjectOpenHashMap<>();
